...
import { videoSubmit } from "../api/submit";
...
export default function VideoForm() {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            if (!allowedExtensions.includes(extension)) {
                toast.error("Only mp4, MOV and webm files are allowed");
    ...
    async function onSubmit(values) {
        const result = await videoSubmit(values);
            ...
            {preview && (
                <div className="mt-4 border rounded-lg p-4">
                    ...
                    <video 
                        ...
                        src={preview} 
                        alt="Preview" 
                        className="h-50 w-40 sm:h-150 sm:w-200 aspect-4/3"
                    />
                </div>
            )}
            <Form {...form}>
